...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        self.experiment = Experiment(api_key="PdU8dZ4I54Nlre5Gz4pW6cY0l",
                                        project_name="sketch-pix2pix", workspace="edolev89")
    ...
    def display_current_results(self, visuals, epoch):
        ...
        if self.display_id > 0:  # show images in the browser using visdom
            ...
            images = [util.tensor2im(image_tensor).transpose([2, 0, 1]) for image_tensor in visuals.values()]

            image_grid_arr = np.concatenate(images, axis=2)
            image_grid_arr_channels_last = np.moveaxis(image_grid_arr, 0, -1)
            image_grid = Image.fromarray(np.uint8(image_grid_arr_channels_last), 'RGB')
